...
const val RECYCLE_BIN_RETENTION_NEVER = 0
const val RECYCLE_BIN_RETENTION_ONE_DAY = 1
const val RECYCLE_BIN_RETENTION_SEVEN_DAYS = 7
const val RECYCLE_BIN_RETENTION_THIRTY_DAYS = 30
const val RECYCLE_BIN_RETENTION_NINETY_DAYS = 90
const val RECYCLE_BIN_RETENTION_365_DAYS = 365
const val DEFAULT_RECYCLE_BIN_RETENTION = RECYCLE_BIN_RETENTION_THIRTY_DAYS
